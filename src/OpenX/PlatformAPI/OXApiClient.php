 ...
 *  It is intendend to be loaded with composer autoloader.
 */

namespace OpenX\PlatformAPI;
...
class OXApiClient extends \ZendRest\Client\RestClient
{
    var $path_prefix = '/ox/4.0';

    public function __construct($uri, $email, $password, $consumer_key, $consumer_secret,
                                $oauth_realm, $cookieJarFile = './OX3_Api_CookieJar.txt',
                                $sso = array(), $proxy = array(), $path = '/ox/4.0')
    {
        ...
        if ($result->isClientError()) {
            ...
            // Parse response, successful headless logins will return oob?oauth_token=<token>&oauth_verifier=<verifier> as the body
